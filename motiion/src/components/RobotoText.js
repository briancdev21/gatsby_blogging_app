...
const RobotoText = styled.div`
  ...
  @media only screen and (max-width: 600px) {
    font-size: ${ props => props.size > 25 ? props.size * 0.9 : props.size }px;
    line-height: ${ props => props.size > 60 ? 1.45 : 1.35 }em
  }
  
  @media only screen and (max-width: 500px) {
    font-size: ${ props => props.size > 25 ? props.size * 0.85 : props.size }px;
    line-height: ${ props => props.size > 60 ? 1.45 : 1.45 }em
  }

  @media only screen and (max-width: 400px) {
    font-size: ${ props => props.size > 25 ? props.size * 0.8 : props.size }px;
