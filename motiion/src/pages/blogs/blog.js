            ...
            <SectionContainer column>
              ...
              <PaddingDiv top={10} bottom={40}>
                <FlexContainer justifyContent="space-between">
                  <PlayFairText weight="900" size={72} color="#000" style={{ textTransform: 'capitalize' }}>
                    {title}
                  </PlayFairText>
                </FlexContainer>
              </PaddingDiv>
              <PaddingDiv bottom={25} top={0}>
                <FlexContainer justifyContent="flex-start">
                  ...
                  <RobotoText size={16} weight={400} color={'#00000066'} style={{ textTransform: 'capitalize' }}>&nbsp;By {author}</RobotoText>
                </FlexContainer>
              </PaddingDiv>
            </SectionContainer>
          </section>
